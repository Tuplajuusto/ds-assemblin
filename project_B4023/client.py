...
class Client:
    ...
    def byid_all(self):
        with self._lock:
            _data = list()
            _data.append("B4023 Room Temperature")
            _data.append("B4023 Room Setpoint Actual")
            _data.append("B4023 Heating Demand")
            _data.append("B4023 Cooling Demand")
            _data.append("B4023 Heating Disabled")
            _data.append("B4023 Cooling Disabled")

...
class Client:
    ...
    def byid_all(self):
        with self._lock:
            _data = list()
            _data.append("B4025 Room Temperature")
            _data.append("B4025 Room Setpoint Actual")
            _data.append("B4025 Heating Demand")
            _data.append("B4025 Cooling Demand")
            _data.append("B4025 Heating Power")
            _data.append("B4025 Cooling Power")

...
class Client:
    ...
    def byid_all(self):
        with self._lock:
            _data = list()
            _data.append("Room Temperature")
            _data.append("Room Setpoint")
            _data.append("Heating Demand")
            _data.append("Heating Power")
            _data.append("Cooling Demand")
            _data.append("Cooling Power")
            _data.append("Heating/Cooling External Control")
            _data.append("Current Outside Temperature")
